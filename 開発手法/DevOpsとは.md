...
## 開発者と運用者の間のジレンマ
システムを開発し運用していくうえで、開発者と運用者が存在します。
どちらも重要な存在ですが、両者の役割の違いからジレンマが生じます。

**開発者**：システムを開発する役割。ユーザの要望に応じて新機能を追加したり、長期的な開発コストを下げるために既存コードへのリファクタリングなどを行う。  
**運用者**：開発されたシステムを運用する役割。
